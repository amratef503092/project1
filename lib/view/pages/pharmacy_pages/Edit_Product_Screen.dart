...
class EditProductScreen extends StatefulWidget {
  ...
  PharmacyCubit pharmacyCubit;
   ...
   EditProductScreen({Key? key, required this.index ,required this.pharmacyCubit})
      : super(key: key);
...
class _EditProductScreenState extends State<EditProductScreen> {
  ...
  void initState() {
    ...
    titleController.text = PharmacyCubit.get(context)
        .productsModel![widget.index]
        .title;
    priceController.text = PharmacyCubit.get(context)
        .productsModel![widget.index]
        .price.toString();
    description.text = PharmacyCubit.get(context)
        .productsModel![widget.index]
        .description;
    quantityController.text =  PharmacyCubit.get(context)
        .productsModel![widget.index]
        .quantity.toString();
    selectedValue = PharmacyCubit.get(context)
        .productsModel![widget.index].type;
    super.initState();
  }
                    ...
                    Padding(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          CustomButton(widget: Text("Confirm Edit"), function: () async{
                            ...
                            if(formKey.currentState!.validate())
                            {
                                PharmacyCubit.get(context).updateProduct(
                                  ...
                                  id: PharmacyCubit.get(context).productsModel![widget.index].id,
                                  type: selectedValue!,
