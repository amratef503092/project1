  ...
  Widget build(BuildContext context) {
    return BlocConsumer<AuthCubit, AuthState>(listener: (context, state) {
      ...
      return Scaffold(
          ...
          (AuthCubit.get(context).userModel!.approved)
              ? BlocProvider(
            create: (context) => pharmacyCubit..getPharmacyProduct(),
            child: BlocConsumer<PharmacyCubit, PharmacyState>(
              builder: (context, state) {
                print(AuthCubit.get(context).userModel!.approved);
              ...
              : (state is GetPharmacyDetailsStateLoading)
              ? const Center(
            child: CircularProgressIndicator(),
          )
              : (AuthCubit.get(context).detailsModelPharmacy==null)?Form(
            key: formKey,
            child: Column(
              children: [
                CircleAvatar(
          ...
          ):Center(child: Text("Waiting Approve from admin"),));
    });
  }
}
